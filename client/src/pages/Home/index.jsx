            ...
            <div className=" ">
              <div className="lg:max-w-xl lg:pr-5">
                ...
                <h2 className="mb-6 max-w-lg text-5xl font-light leading-snug tracking-tight text-black sm:text-7xl sm:leading-snug">
                  Web whiteboard for
                  <span className="my-1 inline-block  bg-[#4454b4] px-4 font-bold text-white mx-4">
                    instant
                  </span>
                  collaboration
                </h2>
              ...
              <div className="mt-10 flex flex-col items-center md:flex-row">
                <Link
                  to={"/form"}
                  className="mb-3  gap-2 no-underline inline-flex h-12 w-full items-center justify-center rounded-md bg-[#4454b4] px-6 font-medium tracking-wide text-white shadow-md transition hover:bg-blue-800 focus:outline-none md:mr-4 md:mb-0 md:w-auto"
                >
                  Start whiteboarding
                  <MoveRight />
                </Link>
